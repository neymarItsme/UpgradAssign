...
export default function Header(props)
{
  ...
  async function LoginHandler() {
    ...
    password === "" ? setLoginPasswordRequired("dispBlock") : setLoginPasswordRequired( "dispNone" );
  ...
  async function RegisterHandler() {
    ...
    inputFirstName === "" ? setFirstNameRequired("dispBlock") : setFirstNameRequired("dispNone");
    inputLastName === "" ? setLastnameRequired("dispBlock") : setLastnameRequired("dispNone");
    inputEmailId === "" ? setEmailRequired("dispBlock") : setEmailRequired("dispNone");
    inputPassword === "" ? setRegisterPasswordRequired("dispBlock") : setRegisterPasswordRequired("dispNone");
    inputContactNo === "" ? setContactRequired("dispBlock") : setContactRequired("dispNone");
  ...
  return(
    <div>
      <header>
        ...
        {/* if bookshow button should appear */}
